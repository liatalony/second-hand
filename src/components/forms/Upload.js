		...
		<>
			{!formFields ? (
				...
				<form onSubmit={handleSubmit}>
					...
					<div className="field">
						...
						>
							...
							{formFields.conditions.map((condition) => {
								return (
									<option
										key={condition.quality_id}
										value={condition.quality_name}
									>
										{condition.quality_name}
									</option>
								);
							})}
						</select>
					...
					<div className="field">
						<label htmlFor={"item_gender"}>Gender</label>
						<select
							id="item_gender"
							name="item_gender"
							required
					...
					<div className="field">
						...
						>
							...
							{formFields.categories.map((category) => {
								return (
									<option key={category.type_id} value={category.type_name}>
										{category.type_name}
									</option>
								);
							})}
					...
					<div className="field">
						<label htmlFor={"item_subcategory"}>Sub Category</label>
						<select
							id="item_subategory"
							name="item_subcategory"
							required
							autoComplete="off"
							value={itemSubSubCategory}
							onChange={(e) => setItemSubSubCategory(e.target.value)}
						>
							<option value={""}>----</option>
					...
					<div className="field">
						...
						>
							...
							{formFields.sizes.map((sizeInt) => {
								return (
									<option
										key={"Int" + sizeInt.size_id}
										value={sizeInt.size_id + " " + sizeInt.size_international}
									>
										{sizeInt.size_international} (EU {sizeInt.size_eu})
									</option>
								);
							})}
							{formFields.sizes.map((sizeEU) => {
								return (
									<option
										key={"EU" + sizeEU.size_id}
										value={sizeEU.size_id + " " + sizeEU.size_eu}
									>
										EU {sizeEU.size_eu}
									</option>
								);
							...
							{formFields.sizes.map((sizeUS) => {
								return (
									<option
										key={"US" + sizeUS.size_id}
										value={sizeUS.size_id + " " + sizeUS.size_us}
									>
										US {sizeUS.size_us}
									</option>
								);
							...
							{formFields.sizes.map((sizeUK) => {
								return (
									<option
										key={"UK" + sizeUK.size_id}
										value={sizeUK.size_id + " " + sizeUK.size_uk}
									>
										UK {sizeUK.size_uk}
									</option>
								);
					...
					<div className="field">
						...
						>
							...
							{formFields.colours.map((colour) => {
								return (
									<option key={colour.colour_id} value={colour.colour_name}>
										{colour.colour_name}
									</option>
								);
							})}
