        ...
        <div>
            ...
            <button className='menu--burger' onClick={handleNavigation}>
                ...
                <ul>
                    ...
                    <li><Link to={"/men"} onClick={handleNavigation}>Men</Link></li>
                    <li><Link to={"/women"} onClick={handleNavigation}>Women</Link></li>
                    <li><Link to={"/about"} onClick={handleNavigation}>About</Link></li>
                    <li><Link to={"/how-it-works"} onClick={handleNavigation}>How It Works</Link></li>
                </ul>
            </nav>
            }
        </div>    
